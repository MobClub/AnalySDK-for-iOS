...
- (void)viewDidLoad {
    ...
    CGFloat b = (0xE3E3E3 & 0xff) / 255.0;
    CGFloat g = (0xE3E3E3 >> 8 & 0xff) / 255.0;
    CGFloat r = (0xE3E3E3 >> 16 & 0xff) / 255.0;
    
    self.tableView.layer.borderColor = [UIColor colorWithRed:r green:g blue:b alpha:1].CGColor;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGFloat b = (0x4B89EA & 0xff) / 255.0;
    CGFloat g = (0x4B89EA >> 8 & 0xff) / 255.0;
    CGFloat r = (0x4B89EA >> 16 & 0xff) / 255.0;
    
    curCell.textLabel.textColor = [UIColor colorWithRed:r green:g blue:b alpha:1];
